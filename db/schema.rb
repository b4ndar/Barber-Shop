...
ActiveRecord::Schema.define(version: 2019_12_24_084954) do
  ...
  create_table "barbers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.integer "raing"
    t.integer "phone"
    t.datetime "created_at", precision: 6, null: false
